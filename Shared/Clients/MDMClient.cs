...
{
    public class MDMClient : IDisposable
    {
        ...
        public MDMClient(IUtilityLogger logger, string baseUrl, string tenantId, string clientId, string clientSecret, string[] scopes)
        {
            _baseUrl = baseUrl;
            _tenantId = tenantId;
            _clientId = clientId;
            ...
            _logger.LogInformation($"#####--------------------------- Initializing MDM API ---------------------------#####");
            var apiToken = _sharedBaseClass.RequestAzureADTokenUsingApplicationIdentityWithExpiry(_tenantId, _clientId, _clientSecret, _scopes, "MDM API").Result;
